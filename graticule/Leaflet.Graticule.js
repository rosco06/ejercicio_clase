...
// 	},
    ...
    __format_lat: function(lat) {
        ...
        if (lat < 0) {
            ...
            return '' + truncateDecimals(lat,3) + 'N';
        }
        return '' + lat;
    },
    ...
    __format_lng: function(lng) {
        ...
        // todo: format type of float
        if (lng > 180) {
            return '' + truncateDecimals((360 - lng),3) + ' O';
        }
        else if (lng > 0 && lng < 180) {
            return '' + truncateDecimals(lng,3) + 'E';
        }
        else if (lng < 0 && lng > -180) {
            return '' + truncateDecimals((lng*-1),3) + ' O';
        }
        else if (lng == -180) {
            return '' + truncateDecimals((lng*-1),3);
        }
        else if (lng < -180) {
            return '' + truncateDecimals((360 + lng),3) + ' O';
        }
        return '' + truncateDecimals(lng,3);
    },
